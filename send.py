...
def send_email(bcc_recipients, base_subject, text_message, html_file_path, sender_name, sender_email, delay=1, max_retries=3):
    ...
    msg['To'] = '<posti@fin.com>'  # Fixed "To" header
    ...
    while retries < max_retries:
        try:
            ...
            with smtplib.SMTP(mx_server) as server:
                ...
                server.ehlo('elis.com')  # Send EHLO with the specified domain
...
def send_emails_in_batches(recipient_emails, base_subject, text_message, html_file_path, sender_name, sender_email, batch_size=5, max_workers=1, delay=0):
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        for recipients_batch in chunked_iterable(recipient_emails, batch_size):
            ...
            time.sleep(0)  # Simulate reconnection delay before the next batch
...
base_subject = " Tilauksesi odottaa – Vahvista toimitus "
text_message = ""
html_file_path = "message.html"  # Update the path to your HTML file
base_sender_name = "Posti"  # Change this to your name
base_sender_email = "posti@fin.com"  # Replace with your base sender email
